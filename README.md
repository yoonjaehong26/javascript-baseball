...
## MVC 패턴 적용 로드맵
1.기존의 1주차 코드에서 model,controller,view폴더로 나누어 
역활에 따라 class내 함수 재배치
2.eslint에 따른 코드컨벤션 적용
3.추가 개선점 확인 밎 리팩터링 진행
...
- **indent(인덴트, 들여쓰기) depth를 2가 넘지 않도록 구현**한다.
...
- 미션 구현을 완료한 후 GitHub을 통해 제출해야 한다.
  - GitHub을 활용한 제출 방법은 [프리코스 과제 제출 문서](https://github.com/woowacourse/woowacourse-docs/tree/master/precourse) 의 8번 항목까지를 참고해 제출한다.
